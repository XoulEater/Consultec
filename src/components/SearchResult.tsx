    ...
    return (
        <ThemeProvider theme={theme}>
            ...
            <div className="flex flex-col items-end gap-6">
                <Button variant="contained" size="large" color="primary" startIcon={<PersonAddIcon />}>
                    Registrar
                </Button>
                ...
                <div className="w-full flex flex-col gap-2">
                    <div className="grid grid-cols-5 p-3 px-5 bg-[#F7F7F7] font-semibold rounded-t-md">
                        ...
                        <div className="text-[#797979]">Ultima Actualización</div>
                        <div className="text-[#797979]">Acciones</div>
                    </div>
                    {/* Data */}
                    {teachers.map((teacher, index) => (
                        <div className="grid grid-cols-5 gap-2 p-3 px-5 hover:bg-[#F7F7F7] transition-all duration-300 ease-in-out cursor-pointer" key={index}>
                            ...
                            <div className="gap-1 flex">
                                {teacher.availability.map((day, index) => (
                                    <span
                                        key={index}
                                        className={`${day === 1 ? "bg-[#7498FA]" : "bg-[#E5EAFE] opacity-50"
                            ...
                            <div className="flex gap-2">
                                <IconButton aria-label="edit" size="medium">
                                    <PencilIcon fontSize="inherit" color="primary" />
                                </IconButton>
