    ...
    return (
        <div className="flex flex-col gap-2">
            ...
            <section className="align-middle flex items-center  relative gap-2 h-12">
                <button
                    className="absolute left-0 py-2 px-3 my-1 border-r-1 border-[#797979] cursor-pointer"
                ...
                <input
                    ...
                    className="w-[600px] p-3 pl-14  bg-[#E8E8E8] border-0 rounded-sm focus:outline-[#1450AC]"
                />
                <button className="bg-[#1450AC] rounded-sm flex items-center justify-center h-full aspect-square cursor-pointer hover:scale-110 hover:opacity-90 transition-all duration-300">
